	...
	e[v] = function (E) {
		...
		nt.each(function () {
			...
			i[u]()[W]()[a](et.menuClass)[C](s, N).on("mouseenter", function () {
				...
				case "fade":
					ot = b,
					S && !et.noOpenerFade ? (et[w] == "slow" ? B = 80 : et[w] == $ ? B = 40 : B = Math.floor(et[w] / 2), d.fadeTo(B, .01, function () {
							d[a](et[t]),
							d.fadeTo(et[w], 1),
...
var skel = function () {
		...
		changeState : function (o) {
			...
			if (!tn[x][vt][tn[i]]) {
				...
				tn[n](a, function (i) {
					...
					tn[e][a[i]][r][f] > 0 && tn[n](tn[e][a[i]][r], function (t) {
						g[r][R](tn[e][a[i]][r][t])
					})
				}),
	...
	return tn.preInit(),
	tn[b][ot] < 9 && (tn[Nt] = function (e) {}, tn[E] = function (e) {
		var t;
...
(function (e) {
	...
	t.registerPlugin(D, function (e) {
		...
		return typeof e == Rt ? K : (e.fn[p] = function () {
			...
			return e(this)[S](t, n)[S](t, Kt + n)[S](t, ht + n)[S](t, an + n)[S](t, nn + n)
				...
				overlayX : {
					show : function (e) {
						var t = e[n],
						r = e[d];
						r[z](0)[c](t.zIndex)[S](t[On], Tn + Yn[pt](t[Ht]) + xn)[cn](),
						t[et] && r[o](),
						t[b] && Yn[xt](bn),
						e[v](),
						e[u](j),
				...
				overlayY : {
					show : function (e) {
						var t = e[n],
						r = e[d];
						r[z](0)[c](t.zIndex)[S](t[On], Tn + Yn[pt](t[rt]) + xn)[cn](),
						t[et] && r[o](),
						t[b] && Yn[xt]("y"),
						e[v](),
						e[u](j),
				...
				pushX : {
					show : function (e) {
						...
						i[z](0)[S](t[On], Tn + Yn[pt](t[Ht]) + xn)[cn](),
						t[et] && i[o](),
						a[c](),
						t[b] && Yn[xt](bn),
						e[v](),
				...
				pushY : {
					show : function (e) {
						...
						i = e[d],
						a = Yn[r][H].add(Yn[r][l][q]());
						i[z](0)[S](t[On], Tn + Yn[Ln](t[rt]) + xn)[cn](),
						t[et] && i[o](),
						t[b] && Yn[xt]("y"),
						e[v](),
						e[u](j),
			...
			o[S](kn, Yn._[gt](t.maxWidth))[S](Sn, Yn._[gt](t.maxHeight))[S](L, t[Ht])[S](Z, t[rt]),
			Yn._.vars[G] == pn && (t[rt] == Nt && !t[st] && o[S](Z, "-webkit-calc(" + t[rt] + " + 70px)"), o.on(mt, "input,select,textarea", function (t, n) {
					if (n)
						return;
					window[s](function () {
						Yn[r][U][Dt](e[it]),
			...
			r.on("touchstart", function (e) {
				...
				if (t[st] && t.swipeToHide) {
					...
					if (a)
						return i[Wt] = C, i[Vt] = C, i[$t](), K
				}
				if (r[z]() == 0 && s < 0 || u > o - 2 && u < o + 2 && s > 0)
					return K
			}),
			this[d] = r
		}, Zn[N][Et] = function () {
			...
			this[rn] && this[$t]()
				...
				create : function (t, i, s) {
					...
					if (t in Yn[r][D])
						return;
					if (h in i) {
						if (!i[jn] && (o = e(Bn + t))[X] == 0)
							return;
						return Yn[n].wrap || (Yn[n].wrap = lt, Yn.initWrappers()),
				...
				destroy : function (i) {
					if (i in Yn[r][D]) {
						var s = Yn[r][D][i];
						return s.suspend(),
						s[n][yn] && s[n][yn] != Yn._.sd && (a = Yn._[mn](s[n][yn]), Yn._[ut](a, function (e) {
				...
				lockView : function (e) {
					e == bn && Yn[r][Hn][S](_, st),
					Yn[n][En] != I && t.vars[G] == pn && Yn[r][W][S](Z, Yn[r].document[Z]()),
				...
				parseInit : function (t) {
					...
					case "navList":
						...
						n.each(function () {
							...
							r = t[Gt]("href"),
							i.push('<a class="link depth-' + n + '"' + (typeof r !== Rt && r != "" ? ' href="' + r + '"' : "") + '><span class="indent-' + n + '"></span>' + t.text() + "</a>")
						}),
				...
				init : function () {
					...
					Yn[n][En] == I && (!Yn._[Qt](I) || !Yn._[Qt](ft)) && (Yn[n][En] = h),
				...
				initAnimation : function () {
					...
					e.fn[k] = function () {
						...
						e.fn[f] = function (n, i) {
							...
							n = parseInt(n),
							i = parseInt(i),
							n != 0 ? ((t.vars[G] == pn ? Yn[r][W] : Yn[r][Pn])[S](_, st), Yn[r][H][S](L, Yn[r][en][L]())) : f = function () {
				...
				initWrappers : function () {
					Yn[n][En] != I ? (Yn[r][Pn].wrapInner('<div id="skel-layers-parent" />'), Yn[r][W] = e("#skel-layers-parent"), Yn[r][W][S](h, sn)[S](O, 0)[S](tt, 0)[S]("min-height", Nt)[S](L, Nt)) : Yn[r][W] = Yn[r][Pn],
					Yn[r][W].wrapInner('<div id="skel-layers-wrapper" />'),
					Yn[r][H] = e("#skel-layers-wrapper"),
					Yn[r][H][S](h, Dn)[S](O, 0)[S](x, 0)[S](tt, 0)[k](),
					Yn[r][U] = e('<div id="skel-layers-hiddenWrapper" />')[vn](Yn[r][W]),
					Yn[r][U][S](Z, Nt),
					Yn[r][l] = e('<div id="skel-layers-visibleWrapper" />')[vn](Yn[r][W]),
					Yn[r][l][S](h, Dn),
					Yn._[jt](_t, Yn[r][U][0]),
		...
		function c(c) {
			...
			for (var f, g, h, i, j, k, l = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})\??|[^.?*+^${[]()|\\]+|./g, m = !1, n = new d, o = [], p = []; f = l.exec(c); )
				...
				case b.alternatormarker:
					o.length > 0 ? (i = o[o.length - 1], k = i.matches.pop()) : k = n.matches.pop(),
					k.isAlternator ? o.push(k) : (j = new d(!1, !1, !1, !0), j.matches.push(k), o.push(j));
					break;
				default:
					if (o.length > 0) {
			...
			return n.matches.length > 0 && (k = n.matches[n.matches.length - 1], k.isGroup && (k.isGroup = !1, e(k, b.groupmarker.start, 0), e(k, b.groupmarker.end)), p.push(n)),
			p
		}
		function d(d, e) {
			if (void 0 == d || "" == d)
	...
	function f(d, e, f) {
		function g(a, b, c) {
			...
			do {
				if (a === !0 && k().validPositions[h]) {
					...
					f = p(h, d, h - 1), e = f.match, d = f.locator.slice(), g.push(F(h, e));
				h++
		...
		function n(b, c, d) {
			if (f.insertMode && void 0 != k().validPositions[b] && void 0 == d) {
				...
				if (!j)
					return k().validPositions = a.extend(!0, {}, g), !1
			} else
				k().validPositions[b] = c;
			return !0
		}
		function o(a, b, c, d) {
			...
			g = a;
			k().p = a,
			void 0 != k().validPositions[a] && k().validPositions[a].input == f.radixPoint && (b++, g++);
			for (e = g; b > e; e++)
		...
		function s(b, c, d) {
			function e(c, d, f, h) {
				function l(f, h, n) {
					if (g > 1e4)
						return alert("jquery.inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + k().mask), !0;
								...
								"string" == typeof w && (t = a.map(t, function (b, c) {
											if (isFinite(c)) {
												...
												for (var f = 0; f < e.length; f++)
													d = -1 != a.inArray(e[f], x), d && (void 0 != b.locator[v] ? (b.locator[v] += ",", b.alternation = v, b.locator[v] += e[f]) : b.locator[v] = parseInt(e[f]));
		...
		function y(b, c, d, e) {
			function g(b, c, d, e) {
				...
				return a.each(s(b), function (h, i) {
					for (var j = i.match, p = c ? 1 : 0, q = "", r = (u(), j.cardinality); r > p; r--)
						q += D(b - (r - 1));
					if (c && (q += c), g = null != j.fn ? j.fn.test(q, k(), b, d, f) : c != j.def && c != f.skipOptionalPartCharacter || "" == j.def ? !1 : {
						...
						if (void 0 != g.remove && o(g.remove, g.remove + 1, !0), g.refreshFromBuffer) {
							...
							if (d = !0, v(x === !0 ? x : x.start, x.end), void 0 == g.pos && void 0 == g.c)
								return g.pos = m(), !1;
							if (t = void 0 != g.pos ? g.pos : b, t != b)
								return g = a.extend(g, y(t, s, !0)), !1
						} else if (g !== !0 && void 0 != g.pos && g.pos != b && (t = g.pos, v(b, t), t != b))
							return g = a.extend(g, y(t, s, !0)), !1;
							...
							for (var n = k().validPositions[j], o = n.locator[h], p = k().validPositions[g].locator[h].split(","), q = 0; q < p.length; q++)
								if (o < p[q]) {
									...
									if (o != r.locator[h]) {
										...
										r.locator[h] = s;
										var x = y(b, c, d, e);
										if (f.keepStatic = !f.keepStatic, x)
											return x;
										l(),
				...
				for (var d = k().validPositions[c], e = d.locator, f = e.length, g = b; c > g; g++)
					if (!z(g)) {
						...
						a.each(h, function (a, b) {
							for (var c = 0; f > c; c++)
								b.locator[c] && x(b.locator[c].toString().split(","), e[c].toString().split(",")) && c > j && (j = c, i = b)
						}),
						n(g, a.extend({}, i, {
								input : i.match.def
							}), !0)
			...
			if (r === !1 && f.keepStatic && N(j) && (r = h(b, c, d, e)), r === !0 && (r = {
				...
				if (!H)
					return l(!0), k().validPositions = a.extend(!0, {}, t), !1
			}
			return r
		}
		function z(a) {
		...
		function G(b, c, d, e) {
			function f() {
				...
				if (-1 != b && !z(n)) {
					a = !0;
					for (var c = t().slice(n, n + b), d = 0; d < c.length; d++)
						if (" " != c[d]) {
							a = !1;
							break
						}
		...
		function K(b, c, d) {
			...
			if ("number" != typeof c)
				return g.setSelectionRange ? (c = g.selectionStart, d = g.selectionEnd) : document.selection && document.selection.createRange && (e = document.selection.createRange(), c = 0 - e.duplicate().moveStart("character", -1e5), d = c + e.text.length), {
					begin : J(c),
					end : J(d)
				};
			if (c = J(c), d = J(d), d = "number" == typeof d ? d : c, a(g).is(":visible")) {
				...
				g.setSelectionRange ? (g.selectionStart = c, g.selectionEnd = d) : g.createTextRange && (e = g.createTextRange(), e.collapse(!0), e.moveEnd("character", d), e.moveStart("character", c), e.select())
			}
		}
		function L(b) {
			var c,
			...
			for (c = g + 1; c < e.length; c++)
				d = p(c, j, c - 1), j = d.locator.slice(), h[c] = a.extend(!0, {}, d);
			var l = i && void 0 != i.alternation ? i.locator[i.alternation].split(",") : [];
			for (c = f - 1; c > g && (d = h[c].match, (d.optionality || d.optionalQuantifier || i && void 0 != i.alternation && void 0 != h[c].locator[i.alternation] && -1 != a.inArray(h[c].locator[i.alternation].toString(), l)) && e[c] == F(c, d)); c--)
				f--;
			return b ? {
				l : f,
		...
		function N(b) {
			if (a.isFunction(f.isComplete))
				return f.isComplete.call(cb, b, f);
			if ("*" == f.repeat)
				return void 0;
			var c = !1,
			d = L(!0),
				...
				if (void 0 == a.valHooks[b] || 1 != a.valHooks[b].inputmaskpatch) {
					...
					a.valHooks[b] = {
						...
						set : function (b, c) {
							...
							f = a(b),
							g = f.data("_inputmask");
							return g ? (e = d(b, a.isFunction(g.opts.onBeforeMask) ? g.opts.onBeforeMask.call(nb, c, g.opts) || c : c), f.triggerHandler("setvalue.inputmask")) : e = d(b, c),
							e
						},
						inputmaskpatch : !0
					}
		...
		function S(c) {
			...
			g == a.inputmask.keyCode.BACKSPACE || g == a.inputmask.keyCode.DELETE || h && 127 == g || c.ctrlKey && 88 == g && !b("cut") ? (c.preventDefault(), 88 == g && (_ = u().join("")), R(d, g, i), E(d, u(), k().p, c, _ != u().join("")), d._valueGet() == t().join("") ? e.trigger("cleared") : N(u()) === !0 && e.trigger("complete"), f.showTooltip && e.prop("title", k().mask)) : g == a.inputmask.keyCode.END || g == a.inputmask.keyCode.PAGE_DOWN ? setTimeout(function () {
				...
				}, 0)) : (f.insertMode = !f.insertMode, K(d, f.insertMode || i.begin != A() ? i.begin : i.begin - 1)),
			hb = -1 != a.inArray(g, f.ignorables)
		}
		function T(b, c, d, e, g) {
			var h = this,
			i = a(h),
			j = b.which || b.charCode || b.keyCode;
			if (!(c === !0 || b.ctrlKey && b.altKey) && (b.ctrlKey || b.metaKey || hb))
				return !0;
			if (j) {
				...
				q = O(o.begin, o.end);
				q && (k().undoPositions = a.extend(!0, {}, k().validPositions), R(h, a.inputmask.keyCode.DELETE, o, !0), o.begin = k().p, f.insertMode || (f.insertMode = !f.insertMode, n(o.begin, e), f.insertMode = !f.insertMode), q = !f.multi),
				k().writeOutBuffer = !0;
				var r = eb && !q ? o.end : o.begin,
				t = y(r, p, e);
				if (t !== !1) {
					if (t !== !0 && (r = void 0 != t.pos ? t.pos : r, p = void 0 != t.c ? t.c : p), l(!0), void 0 != t.caret)
						m = t.caret;
					else {
				...
				if (d !== !1) {
					...
					if (setTimeout(function () {
						...
						q && (k().buffer = void 0, k().validPositions = k().undoPositions)
				} else
					q && (k().buffer = void 0, k().validPositions = k().undoPositions);
		...
		function V(b) {
			...
			return G(c, !0, !1, eb ? j.split("").reverse() : j.split("")),
			d.click(),
		...
		function X(a) {
			var b = this;
			_ = u().join(""),
			("" == bb || 0 != a.originalEvent.data.indexOf(bb)) && (ab = K(b))
		}
		function Y(b) {
			var c = this,
			d = ab || K(c);
		...
		function $(b) {
			if (cb = a(b), cb.is(":input") && c(cb.attr("type"))) {
				if (cb.data("_inputmask", {
					...
					d.isRTL = !0,
					cb.data("_inputmask", d),
					eb = !0
				}
				cb.unbind(".inputmask"),
				cb.closest("form").bind("submit", function () {
					_ != u().join("") && cb.change(),
					cb[0]._valueGet && cb[0]._valueGet() == t().join("") && cb[0]._valueSet(""),
				...
				cb.bind("mouseenter.inputmask", function () {
					...
					if (c.data("_inputmask")) {
						...
						g = u().slice();
						ib = !0,
						_ != g.join("") && (c.change(), _ = g.join("")),
						"" != e && (f.clearMaskOnLostFocus && (e == t().join("") ? g = [] : M(g)), N(g) === !1 && (c.trigger("incomplete"), f.clearIncomplete && (l(), g = f.clearMaskOnLostFocus ? [] : t().slice())), E(d, g, void 0, b))
					}
					...
					if (b.is(":focus")) {
						var d = K(c);
						if (d.begin == d.end)
							if (f.radixFocus && "" != f.radixPoint && -1 != a.inArray(f.radixPoint, u()) && (ib || u().join("") == t().join("")))
								K(c, a.inArray(f.radixPoint, u())), ib = !1;
							else {
				...
				cb.bind("keydown.inputmask", S).bind("keypress.inputmask", T).bind("keyup.inputmask", U),
				i || cb.bind("compositionstart.inputmask", X).bind("compositionupdate.inputmask", Y).bind("compositionend.inputmask", Z),
				"paste" === j && cb.bind("input.inputmask", W),
				Q(b);
		...
		if (void 0 != d)
			...
			case "format":
				...
				return G(cb, !1, !1, eb ? jb.reverse() : jb),
			...
			case "getmetadata":
				if (cb = a(d.el), e = cb.data("_inputmask").maskset, f = cb.data("_inputmask").opts, a.isArray(e.metadata)) {
					for (var qb, rb = m(), sb = rb; sb >= 0; sb--)
						if (k().validPositions[sb] && void 0 != k().validPositions[sb].alternation) {
	...
	if (void 0 === a.fn.inputmask) {
		...
		a.fn.inputmask = function (b, c) {
			...
			if ("string" == typeof b)
				...
				if ("object" == typeof b)
					return i = a.extend(!0, {}, a.inputmask.defaults, b), d(i.alias, b, i), h = e(i), void 0 == h ? this : this.each(function () {
						f({
							action : "mask",
							el : this
						}, a.extend(!0, {}, h), g(this, i))
		...
		"dd/mm/yyyy" : {
			...
			onKeyUp : function (b) {
				...
				if (b.ctrlKey && b.keyCode == a.inputmask.keyCode.RIGHT) {
					...
					c.triggerHandler("setvalue.inputmask")
				}
			},
	...
	return a.extend(a.inputmask.defaults.aliases, {
		numeric : {
			mask : function (a) {
				...
				a.radixFocus = a.radixFocus && "0" == a.placeholder,
				a.definitions[";"] = a.definitions["~"];
				var e = b(a.prefix);
				return e += "[+]",
				e += "~{1," + a.integerDigits + "}",
				void 0 != a.digits && (isNaN(a.digits) || parseInt(a.digits) > 0) && (e += a.digitsOptional ? "[" + (a.decimalProtect ? ":" : a.radixPoint) + ";{" + a.digits + "}]" : (a.decimalProtect ? ":" : a.radixPoint) + ";{" + a.digits + "}"),
				e += b(a.suffix),
				e += "[-]",
				a.greedy = !1,
				e
			...
			postFormat : function (b, c, d, e) {
				...
				if (i.length > 0 && e.autoGroup || d && -1 != i.indexOf(e.groupSeparator)) {
					...
					i = i.replace(new RegExp(k, "g"), "");
					var l = i.split(e.radixPoint);
					if (i = "" == e.radixPoint ? i : l[0], i != e.prefix + "?0" && i.length >= e.groupSize + e.prefix.length)
						for (var m = new RegExp("([-+]?[\\d?]+)([\\d?]{" + e.groupSize + "})"); m.test(i); )
							i = i.replace(m, "$1" + e.groupSeparator + "$2"), i = i.replace(e.groupSeparator + e.groupSeparator, e.groupSeparator);
			...
			onBeforeWrite : function (b, c, d, e) {
				if (b && "blur" == b.type) {
					...
					if (g = g.replace(e.suffix, ""), g = g.replace(new RegExp(a.inputmask.escapeRegex.call(this, e.groupSeparator), "g"), ""), g = g.replace(a.inputmask.escapeRegex.call(this, e.radixPoint), "."), isFinite(g) && isFinite(e.min) && parseFloat(g) < parseFloat(e.min))
						return e.postFormat((e.prefix + e.min).split(""), 0, !0, e);
			...
			postValidation : function (b, c) {
				...
				isFinite(f) && isFinite(c.max) && (d = parseFloat(f) <= parseFloat(c.max)),
				d
			},
			definitions : {
				"~" : {
				...
				"+" : {
					validator : function (a, b, c, d, e) {
						...
						return !f && (d && e.allowMinus && a === e.negationSymbol.front || e.allowMinus && "-" == a || e.allowPlus && "+" == a) && (f = !0),
						f
					},
					cardinality : 1,
					prevalidator : null,
			...
			onBeforeMask : function (b, c) {
				...
				return 0 == c.digits && (-1 != b.indexOf(".") ? b = b.substring(0, b.indexOf(".")) : -1 != b.indexOf(",") && (b = b.substring(0, b.indexOf(",")))),
				b
			},
			canClearPosition : function (b, c, d, e, f) {
				var g = b.validPositions[c].input,
				h = g != f.radixPoint && isFinite(g) || c == d || g == f.groupSeparator;
				if (h && isFinite(g)) {
					...
					if (i = l.join("").match(f.regex.integerNPart(f)), radixPosition = a.inArray(f.radixPoint, b.buffer), i && (-1 == radixPosition || c <= radixPosition))
						if (0 == i[0].indexOf("0"))
							h = i.index != c || -1 == radixPosition;
						else {
